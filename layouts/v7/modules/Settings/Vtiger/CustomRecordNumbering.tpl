            ...
            <div class="blockData">
                <div class="clearfix">
                    <div class="btn-group pull-right">
                        <button type="button" class="btn addButton btn-default module-buttons" name="updateRecordWithSequenceNumber">{vtranslate('LBL_UPDATE_MISSING_RECORD_SEQUENCE', $QUALIFIED_MODULE)}</button>
                    </div>
                    <div>
                ...
                <div class="table form-horizontal no-border" id="customRecordNumbering" >
                    ...
                    <div class="row form-group"><div class="col-lg-3 col-md-3 col-sm-3 control-label fieldLabel">
                        ...
                        <div class="fieldValue {$WIDTHTYPE}">
                            <div class=" col-lg-4 col-md-4 col-sm-4"><input type="text" id="prefix" class="inputElement" value="{$DEFAULT_MODULE_DATA['prefix']}" data-old-prefix="{$DEFAULT_MODULE_DATA['prefix']}" name="prefix" />
                            </div></div>
                    </div>
                    <div class="row form-group"><div class="col-lg-3 col-md-3 col-sm-3 control-label fieldLabel">
                            <label>
                        ...
                        <div class="fieldValue  {$WIDTHTYPE}">
                            <div class=" col-lg-4 col-md-4 col-sm-4"> <input type="text" value="{$DEFAULT_MODULE_DATA['sequenceNumber']}" class="inputElement " id="sequence"
