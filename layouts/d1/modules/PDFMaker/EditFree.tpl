                                ...
                                <div class="row">
                                    <div class="col text-end">
                                        {if $REQUEST_INSTANCE.return_view neq ''}
                                            <a class="btn btn-primary cancelLink" type="reset" onclick="window.location.href = 'index.php?module={if $REQUEST_INSTANCE.return_module neq ''}{$REQUEST_INSTANCE.return_module}{else}PDFMaker{/if}&view={$REQUEST_INSTANCE.return_view}{if $REQUEST_INSTANCE.templateid neq ""  && $REQUEST_INSTANCE.return_view neq "List"}&templateid={$REQUEST_INSTANCE.templateid}{/if}';">{vtranslate('LBL_CANCEL', $MODULE)}</a>
                                        {else}
