                ...
                <div class="row">
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-sm-8 fieldValue">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('articelvar');" title="{vtranslate('LBL_INSERT_TO_TEXT','EMAILMaker')}">
                                                            <i class="fa fa-usd"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-sm-8 fieldValue">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('psfields');" title="{vtranslate('LBL_INSERT_TO_TEXT','EMAILMaker')}">
                                                            <i class="fa fa-usd"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-sm-8 fieldValue">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('productfields');" title="{vtranslate('LBL_INSERT_TO_TEXT','EMAILMaker')}">
                                                            <i class="fa fa-usd"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-sm-8 fieldValue">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('servicesfields');" title="{vtranslate('LBL_INSERT_TO_TEXT','EMAILMaker')}">
                                                            <i class="fa fa-usd"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane" id="pContentLabels">
                                    <div>
                                        <div class="row py-2">
                                            ...
                                            <div class="col-sm-8 fieldValue">
                                                <div class="input-group">
                                                    ...
                                                    <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('global_lang');" title="{vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}">
                                                        <i class="fa fa-usd"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row py-2">
                                            ...
                                            <div class="col-sm-8 fieldValuecol-sm-8 fieldValue">
                                                <div class="input-group">
                                                    <select name="custom_lang" id="custom_lang" class="select2 form-select" data-width="50%">
                                                        {html_options  options=$CUSTOM_LANG_LABELS}
                                                    </select>
                                                    <button type="button" class="btn btn-success small create" onclick="EMAILMaker_EditProductBlock_Js.InsertIntoTemplate('custom_lang');" title="{vtranslate('LBL_INSERT_TO_TEXT','PDFMaker')}">
                                                        <i class="fa fa-usd"></i>
                                                    </button>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg">
                        <div class="rounded p-3 bg-body">
                            {*********************************************BODY DIV*************************************************}
                            <textarea name="body" id="body" class=small tabindex="5">{$EDIT_TEMPLATE.body}</textarea>
