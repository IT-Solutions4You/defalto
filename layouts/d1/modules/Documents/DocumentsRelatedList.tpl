                    ...
                    <div class="btn-toolbar">
                        {foreach item=RELATED_LINK from=$RELATED_LIST_LINKS['LISTVIEWBASIC']}
                            {if $RELATED_LINK->get('linkmodule') eq 'Documents'}
                                ...
                                {/if}
                                <button type="button" module="{$RELATED_MODULE_NAME}" class="btn btn-outline-primary me-2 addButton {if $IS_SELECT_BUTTON eq true}selectRelation{/if}"
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li id="VtigerAction">
                                                <a class="dropdown-item" href="javascript:Documents_Index_Js.uploadTo('Vtiger',{$PARENT_ID},'{$MODULE}')">
                                                    ...
                                                    <span class="ms-2">{vtranslate('LBL_TO_SERVICE', $RELATED_MODULE_NAME, {vtranslate('LBL_VTIGER', $RELATED_MODULE_NAME)})}</span>
                                                </a>
                                            </li>
                                            <li>
