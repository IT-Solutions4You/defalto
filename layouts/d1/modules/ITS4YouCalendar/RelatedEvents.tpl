        ...
        <div class="widget_header clearfix">
            ...
            <div class="pull-right" style="margin-top: -5px;">
                {if $CALENDAR_MODEL->isPermitted('CreateView')}
                    <button class="btn addButton btn-sm btn-default createEvent textOverflowEllipsis max-width-100" title="{vtranslate('LBL_ADD_EVENT',$ACTIVITIES_MODULE_NAME)}" data-name="{$ACTIVITIES_MODULE_NAME}"
