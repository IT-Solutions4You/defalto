...
var vtUtils = {
    ...
    isEmailValidated: function (email) {
        let regex = /^[_a-zA-Z0-9áàâäãåāăąćčďéèêëēęěíìîïīįıĺľłńñňóòôöõőøōœŕřśšţťúùûüůűūýÿžźż]+([!"#$%&'()*+,.\:;<=>?\^_`{|}~-]?[a-zA-Z0-9\_\-])*@[a-zA-Z0-9áàâäãåāăąćčďéèêëēęěíìîïīįıĺľłńñňóòôöõőøōœŕřśšţťúùûüůűūýÿžźż]+([\_\-\.]?[a-zA-Z0-9]+)*\.([\-\_]?[a-zA-Z0-9])+(\.?[a-zA-Z0-9]+)?$/
