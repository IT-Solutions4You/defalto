...
{if $FIELD_MODEL->get('uitype') eq '53'}
	...
	{/if}
	<div class="Vtiger_Owner_UIType">
		<select class="inputElement form-control select2" type="owner" data-fieldtype="owner" data-fieldname="{$ASSIGNED_USER_ID}" data-name="{$ASSIGNED_USER_ID}" name="{$ASSIGNED_USER_ID}"
