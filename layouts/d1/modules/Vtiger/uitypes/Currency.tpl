    ...
    <div class="Vtiger_Currency_UIType">
        {if $FIELD_MODEL->get('uitype') eq '71'}
            <div class="input-group inputElement">
                <span class="input-group-addon input-group-addon-right input-group-text">{$USER_MODEL->get('currency_symbol')}</span>
        ...
        {elseif ($FIELD_MODEL->get('uitype') eq '72') && ($FIELD_NAME eq 'unit_price')}
            <div class="input-group inputElement" style="float:none;">
                <span class="input-group-addon input-group-addon-right input-group-text" id="baseCurrencySymbol">{$BASE_CURRENCY_SYMBOL}</span>
        ...
        {else}
            <div class="input-group">
                <span class="input-group-addon input-group-text" id="basic-addon1">{$USER_MODEL->get('currency_symbol')}</span>
