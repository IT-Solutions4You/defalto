 ...
 *}
{strip}
    <div class="related-tabs col-lg-3 col-xl-2 order-1 order-lg-2 pt-3">
        <div class="bg-body rounded h-100 px-3">
            <div class="d-block d-lg-none py-2" data-bs-toggle="collapse" data-bs-target="#relatedTabs">
                <div class="btn btn-outline-secondary">
                    <i class="fa fa-bars"></i>
                    <b class="ms-2">{vtranslate('LBL_NAVIGATION', $QUALIFIED_MODULE)}</b>
                </div>
            </div>
            <div id="relatedTabs" class="collapse d-lg-block">
