...
<html>
	<head>
        ...
        <link type='text/css' rel='stylesheet' href='{vresource_url("layouts/d1/lib/jquery/select2/select2.css")}'>
        <link type='text/css' rel='stylesheet' href='{vresource_url("layouts/d1/lib/select2-bootstrap/select2-bootstrap.css")}'>
