            ...
            <div class="commentHeader col-lg-auto">
                <div class="form-check form-switch">
                    <label class="form-check-label" for="rollupcomments">
                        ...
                        <span class="fa fa-question-circle text-secondary" data-bs-toggle="tooltip" data-placement="top" title="{vtranslate('LBL_SHOW_RELATED_COMMENTS_INFO',$QUALIFIED_MODULE)}"></span>
                    </label>
