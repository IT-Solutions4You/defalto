        ...
        <div class="row h-100">
            ...
            <div class="col overflow-auto">
                <div class="container bg-body my-3 rounded shadow pb-5">
                    ...
                    <a class="row align-items-center py-3" href="index.php?module=Tour&view=Redirect&mode=Web" target="_blank">
                    ...
                    <a class="row align-items-center py-3" href="index.php?module=Tour&view=Redirect&mode=Documentation" target="_blank">
                        <div class="col-lg-2 fs-1 text-center text-primary">
                    ...
                    <a class="row align-items-center py-3" href="index.php?module=Tour&view=Redirect&mode=Forum" target="_blank">
                        <div class="col-lg-2 fs-1 text-center text-primary">
