			...
			<div class="col-lg-12 inner-container">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						Connect with us &nbsp;&nbsp;
						<a href="https://www.facebook.com/vtiger" target="_blank"><img src="layouts/d1/skins/images/facebook.png"></a>&nbsp;&nbsp;
						<a href="https://twitter.com/vtigercrm" target="_blank"><img src="layouts/d1/skins/images/twitter.png"></a>&nbsp;&nbsp;
					</div>
				</div>
