...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$REQUEST_INSTANCE.view} transitionsAllHalfSecond">
				...
				{else if $REQUEST_INSTANCE.view eq 'Edit'}
				...
				{if $REQUEST_INSTANCE.view eq 'Detail'}
