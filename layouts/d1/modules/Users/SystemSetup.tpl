			...
			<style type="text/css">
				{literal}
					...
					.group-heading .basicChkbox{
						...
						width:24px;
						height:24px;
						background: url("layouts/d1/skins/images/check_radio_sprite.png") no-repeat 0 0;
						opacity: 0.65;
					}
					.group-desc{
						padding-bottom:9px;
					...
					input[type="radio"] + div::before
					{
						...
						height: 24px;
						margin-right: 6px;
						background: url("layouts/d1/skins/images/check_radio_sprite.png") no-repeat 0 -24px;
									...
									<div class="group-container {if $COUNTER eq 0} span12 selectedContainer js-basePack {else} span6 {/if}">
										...
										<div class="row-fluid">
											<div class="{if $COUNTER eq 0} span2 {else} span3 {/if}">
												<img src="layouts/d1/skins/images/{$PACKAGE_INFO.imageName}" alt="Vtiger Logo"/>
											</div>
