...
{strip}
	<style>
		body {
			background: url(layouts/d1/resources/Images/login-background.jpg);
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/d1/resources/Images/vtiger.png">
				<div>
			...
			<div class="marketingDiv widgetHeight">
				...
				{else}
					<div class="inActiveImgDiv">
						...
						<a href="https://marketplace.vtiger.com/app/listings" target="_blank" style="margin-right: 25px;"><img src="layouts/d1/resources/Images/extensionstore.png" style="width: 85%; height: 100%; margin-top: 25px;"/></a>
					</div>
				{/if}
				</div>
			</div>
