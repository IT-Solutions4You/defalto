...
{strip}
    ...
    <head>
        ...
        <script type="text/javascript">
            {literal}
            jQuery(function () {
                jQuery('select').select2({blurOnChange: true, theme: 'bootstrap-5'});
        ...
        <style type="text/css">
            {literal}
            body {
                background: #ffffff url('layouts/v7/skins/images/usersetupbg.png') no-repeat center top;
                background-size: 100%;
                font-size: 14px;
            }
    ...
    <div class="container py-3 px-4">
        <form class="form" method="POST" action="index.php?module=Users&action=UserSetupSave">
            ...
            <div class="rounded bg-body" {if false && $IS_FIRST_USER}style="width: 700px;"{/if}> {* FirstUser information gather - paused *}
                <div>
                    <div>
                                ...
                                <div class="col-lg-6">
                                    {if false && $IS_FIRST_USER} {* FirstUser information gather - paused *}
                                        <div>
                                            <label class="control-label py-2">
                                                <strong>{vtranslate('LBL_ABOUT_ME', $MODULE)}</strong>
                                                <span class="muted">{vtranslate('LBL_WE_PROMISE_TO_KEEP_THIS_PRIVATE', $MODULE)}</span>
                                            </label>
                                            <div class="controls py-2">
                                                <input type="text" name="about[phone]" id="phone" class="form-control" placeholder="{vtranslate('LBL_PHONE', $MODULE)}" rel="tooltip" title="{vtranslate('LBL_YOUR_CONTACT_NUMBER', $MODULE)}">
                                            </div>
                                            <div class="controls py-2">
                                                <select name="about[country]" id="country" class="form-select" placeholder="{vtranslate('LBL_SELECT_COUNTRY', $MODULE)}" rel="tooltip" title="{vtranslate('LBL_WHERE_ARE_YOU_FROM', $MODULE)}">
                                            ...
                                            <div class="controls py-2">
                                                <select name="about[company_size]" id="company_size" class="form-select" placeholder="{vtranslate('LBL_COMPANY_SIZE', $MODULE)}">
                                                    <option value=""></option><!-- to allow select2 pick placeholder -->
                                                    <option value="Prefer Not to Disclose">Prefer Not to Disclose</option>
                                            ...
                                            <div class="controls py-2">
                                                <select name="about[company_job]" id="company_job" class="form-select" placeholder="{vtranslate('LBL_JOB_TITLE', $MODULE)}">
                                                    <option value=""></option><!-- to allow select2 pick placeholder -->
                                                    <option value="Prefer Not to Disclose">Prefer Not to Disclose</option>
                                            ...
                                            <div class="controls py-2">
                                                <select name="about[department]" id="department" class="form-select" placeholder="{vtranslate('LBL_DEPARTMENT', $MODULE)}">
                                                    <option value=""></option><!-- to allow select2 pick placeholder -->
                                                    <option value="Prefer Not to Disclose">Prefer Not to Disclose</option>
                                    ...
                                    <div class="span4">
                                        <label class="control-label">
                                            <strong>{vtranslate('Preferences', $MODULE)}</strong>
                                            <span class="muted">{vtranslate('LBL_ALL_FIELDS_BELOW_ARE_REQUIRED', $MODULE)}</label>
                                        {if $IS_FIRST_USER}
                                            <div class="controls py-2" id="currency_name_controls">
                                                <div class="input-group">
                                                    <select name="currency_name" id="currency_name" placeholder="{vtranslate('LBL_BASE_CURRENCY', $MODULE)}" data-errormessage="{vtranslate('LBL_CHOOSE_BASE_CURRENCY', $MODULE)}" class="validate[required]">
                                                        <option value=""></option>
                                                    ...
                                                    <span class="input-group-text" rel="tooltip" title="{vtranslate('LBL_OPERATING_CURRENCY', $MODULE)}" id="currency_name_tooltip">
                                        ...
                                        <div class="controls py-2">
                                            <div class="input-group">
                                                <select name="lang_name" id="lang_name" placeholder="{vtranslate('LBL_LANGUAGE', $MODULE)}" data-errormessage="{vtranslate('LBL_CHOOSE_LANGUAGE', $MODULE)}" class="validate[required]">
                                                    <option value=""></option>
                                        ...
                                        <div class="controls py-2">
                                            <div class="input-group">
                                                <select name="time_zone" id="time_zone" placeholder="{vtranslate('LBL_CHOOSE_TIMEZONE', $MODULE)}" data-errormessage="{vtranslate('LBL_CHOOSE_TIMEZONE', $MODULE)}" class="validate[required]">
                                                    <option value=""></option>
                                        ...
                                        <div class="controls py-2">
                                            <div class="input-group">
                                                <select name="date_format" id="date_format" placeholder="{vtranslate('LBL_DATE_FORMAT', $MODULE)}" data-errormessage="{vtranslate('LBL_CHOOSE_DATE_FORMAT', $MODULE)}" class="validate[required]">
                                                    <option value=""></option>
