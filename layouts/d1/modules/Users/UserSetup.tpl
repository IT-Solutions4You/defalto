										...
										{if false && $IS_FIRST_USER} {* FirstUser information gather - paused *}
											<div>
												...
												<div class="controls py-2">
													<input type="text" name="about[phone]" id="phone" class="form-control" placeholder="{vtranslate('LBL_PHONE', $MODULE)}" rel="tooltip" title="{vtranslate('LBL_YOUR_CONTACT_NUMBER', $MODULE)}" style="width:250px;">
												</div>
												<div class="controls py-2">
													<select name="about[country]" id="country" class="form-select" placeholder="{vtranslate('LBL_SELECT_COUNTRY', $MODULE)}" rel="tooltip" title="{vtranslate('LBL_WHERE_ARE_YOU_FROM', $MODULE)}" style="width:250px;">
