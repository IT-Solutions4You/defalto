...
function vtJsonDependentModules($adb, $request)
{
    ...
    $result = $adb->pquery(
        "SELECT fieldname, tabid, typeofdata, vtiger_ws_referencetype.type as reference_module FROM vtiger_field
    ...
    $filterModules = ['Invoice', 'Quotes', 'SalesOrder', 'PurchaseOrder', 'Accounts'];
    $skipFieldsList = [];
