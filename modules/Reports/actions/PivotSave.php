...
class Reports_PivotSave_Action extends Reports_Save_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		$data = array();
		$data['rows'] = $request->get('rowfields');
		$data['columns'] = $request->get('columnfields');
		$data['functions'] = $request->get('datafields');
