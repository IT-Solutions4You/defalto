...
class Invoice_Record_Model extends Vtiger_Record_Model
{
    ...
    public function getCreatePurchaseOrderUrl()
    {
        ...
        return 'index.php?module=' . $purchaseOrderModuleModel->getName() . '&view=' . $purchaseOrderModuleModel->getEditViewName() . '&sourceModule=Invoice&sourceRecord=' . $this->getId() . '&invoice_id=' . $this->getId();
    }
