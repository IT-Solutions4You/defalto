...
vtws_addActorTypeWebserviceEntityWithName(
    ...
    'VtigerTaxOperation',
    ['fieldNames' => 'tax_label', 'indexField' => 'tax_id', 'tableName' => 'df_taxes'],
    true
);
...
Migration_Index_View::ExecuteQuery(
    ...
    [$webserviceObject->getEntityId(), 'df_taxes']
);
...
Migration_Index_View::ExecuteQuery("INSERT INTO vtiger_ws_entity_tables(webservice_entity_id,table_name) VALUES (?,?)", [$webserviceObject->getEntityId(), 'df_taxes_records']);
...
Migration_Index_View::ExecuteQuery(
    ...
    [$fieldTypeId, 'df_taxes_records', 'record_id', "reference"]
);
...
Migration_Index_View::ExecuteQuery(
    "INSERT INTO vtiger_ws_entity_fieldtype(fieldtypeid,table_name,field_name,fieldtype) VALUES (?,?,?,?);",
    [$fieldTypeId, 'df_taxes_records', 'tax_id', "reference"]
);
