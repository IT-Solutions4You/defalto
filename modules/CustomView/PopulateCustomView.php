...
function create_custom_views()
{
    ...
    $cvcolumns = [
        ...
        [
            ...
            'vtiger_quotes:potential_id:potential_id:Quotes_Potential_Name:I',
            'vtiger_quotes:account_id:account_id:Quotes_Account_Name:I',
            'vtiger_quotes:grand_total:grand_total:Quotes_Total:I',
