...
class DefaultDataPopulator extends CRMEntity
{
    ...
    function create_tables()
    {
        ...
        $fields = [
            ...
            [20, null, 'subtotal', 'vtiger_quotes', 1, '72', 'subtotal', 'Sub Total', 1, 2, '', 100, 9, $quoteInformation, 3, 'N~O', 3, null, 'BAS', 1],
            ...
            [20, null, 'adjustment', 'vtiger_quotes', 1, '72', 'adjustment', 'Adjustment', 1, 2, '', 100, 20, $quoteInformation, 3, 'NN~O', 3, null, 'BAS', 1],
            [20, null, 'price_total', 'vtiger_quotes', 1, '72', 'price_total', 'Total', 1, 2, '', 100, 14, $quoteInformation, 3, 'N~O', 3, null, 'BAS', 1],
            ...
            [20, null, 'discount_amount', 'vtiger_quotes', 1, '72', 'discount_amount', 'Discount Amount', 1, 2, '', 100, 14, $quoteInformation, 3, 'N~O', 3, null, 'BAS', 1],
            ...
            [21, null, 'adjustment', 'vtiger_purchaseorder', 1, '72', 'adjustment', 'Adjustment', 1, 2, '', 100, 10, $purchaseOrderInformation, 3, 'NN~O', 3, null, 'BAS', 1],
            ...
            [21, null, 'price_total', 'vtiger_purchaseorder', 1, '72', 'price_total', 'Total', 1, 2, '', 100, 13, $purchaseOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            [21, null, 'subtotal', 'vtiger_purchaseorder', 1, '72', 'subtotal', 'Sub Total', 1, 2, '', 100, 14, $purchaseOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            //Added fields taxtype, discount percent, discount amount and S&H amount for Tax process
            ...
            [21, null, 'discount_amount', 'vtiger_purchaseorder', 1, '72', 'discount_amount', 'Discount Amount', 1, 0, '', 100, 14, $purchaseOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            ...
            [22, null, 'adjustment', 'vtiger_salesorder', 1, '72', 'adjustment', 'Adjustment', 1, 2, '', 100, 12, $salesOrderInformation, 3, 'NN~O', 3, null, 'BAS', 1],
            ...
            [22, null, 'price_total', 'vtiger_salesorder', 1, '72', 'price_total', 'Total', 1, 2, '', 100, 14, $salesOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            [22, null, 'subtotal', 'vtiger_salesorder', 1, '72', 'subtotal', 'Sub Total', 1, 2, '', 100, 15, $salesOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            //Added fields taxtype, discount percent, discount amount and S&H amount for Tax process
            ...
            [22, null, 'discount_amount', 'vtiger_salesorder', 1, '72', 'discount_amount', 'Discount Amount', 1, 0, '', 100, 15, $salesOrderInformation, 3, 'N~O', 3, null, 'BAS', 1],
            ...
            [23, null, 'adjustment', 'vtiger_invoice', 1, '72', 'adjustment', 'Adjustment', 1, 2, '', 100, 9, $invoiceInformation, 3, 'NN~O', 3, null, 'BAS', 1],
            ...
            [23, null, 'subtotal', 'vtiger_invoice', 1, '72', 'subtotal', 'Sub Total', 1, 2, '', 100, 12, $invoiceInformation, 3, 'N~O', 3, null, 'BAS', 1],
            [23, null, 'price_total', 'vtiger_invoice', 1, '72', 'price_total', 'Total', 1, 2, '', 100, 13, $invoiceInformation, 3, 'N~O', 3, null, 'BAS', 1],
            //Added fields taxtype, discount percent, discount amount and S&H amount for Tax process
            ...
            [23, null, 'discount_amount', 'vtiger_invoice', 1, '72', 'discount_amount', 'Discount Amount', 1, 2, '', 100, 13, $invoiceInformation, 3, 'N~O', 3, null, 'BAS', 1],
