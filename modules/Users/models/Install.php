...
class Users_Install_Model extends Vtiger_Install_Model
{
    ...
    public function installTables(): void
    {
        $this->getTable('vtiger_users', null)
            ...
            ->createColumn('address_street', 'varchar(150) DEFAULT NULL')
            ->createColumn('address_city', 'varchar(100) DEFAULT NULL')
            ->createColumn('address_state', 'varchar(100) DEFAULT NULL')
            ->createColumn('address_country_id', 'varchar(2) DEFAULT NULL')
            ->createColumn('address_postalcode', 'varchar(9) DEFAULT NULL')
