...
class Assets extends CRMEntity
{
     ...
     */
    var $customFieldTable = ['vtiger_assetscf', 'assetsid'];

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    var $tab_name = ['vtiger_crmentity', 'vtiger_assets', 'vtiger_assetscf'];
    ...
    var $required_fields = ['assetname' => 1];

    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = ['assetname', 'product', 'assigned_user_id'];
