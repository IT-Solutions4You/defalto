    ...
    public function save_related_module($module, $crmid, $with_module, $with_crmids, $otherParams = array())
    {
        ...
        foreach ($with_crmids as $with_crmid) {
            if ($with_module == 'Leads') {
                ...
                $adb->pquery('INSERT INTO vtiger_campaignleadrel VALUES(?,?,1)', array($crmid, $with_crmid));
                ...
                $adb->pquery('INSERT INTO vtiger_campaigncontrel VALUES(?,?,1)', array($crmid, $with_crmid));
                $this->setTrackLinkedInfo($crmid, $with_crmid);
                ...
                $adb->pquery('INSERT INTO vtiger_campaignaccountrel VALUES(?,?,1)', array($crmid, $with_crmid));
                $this->setTrackLinkedInfo($crmid, $with_crmid);
            } else {
