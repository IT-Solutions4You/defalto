...
class Core_TemplateContent_Helper extends Vtiger_Base_Model
{
    ...
    public function getBranding(): string
    {
        ...
        return '<div style="text-align: center; font-size: 10px; display: block !important;"><a href="https://defalto.com" style="display: block !important; color: black;">Generated by Defalto CRM</a></div>';
    }
}