...
class Core_InventoryItemsBlock_Model extends Core_RelatedBlock_Model
{
    ...
    protected array $skippedFields = ['margin', 'margin_amount', 'margin_combined'];
    ...
    {
        $fields = InventoryItem_Module_Model::getSelectedFields($this->getModule()->getId());

        return array_diff($fields, $this->skippedFields);
    }
