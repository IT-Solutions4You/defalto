...
class Project extends CRMEntity
{
     ...
     */
    var $customFieldTable = ['vtiger_projectcf', 'projectid'];

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    var $tab_name = ['vtiger_crmentity', 'vtiger_project', 'vtiger_projectcf'];
    ...
    var $required_fields = ['projectname' => 1];
    ...
    function get_gantt_chart($id, $cur_tab_id, $rel_tab_id, $actions = false)
    {
        ...
        while ($rec_related_projecttasks = $adb->fetchByAssoc($related_projecttasks)) {
            ...
            $g->addTask(
                $rec_related_projecttasks['projecttaskid'],
                $rec_related_projecttasks['startdate'],
                $rec_related_projecttasks['enddate'],
                $percentage,
                $rec_related_projecttasks['projecttaskname']
            );
        }
        ...
        while ($rec_related_projectmilestones = $adb->fetchByAssoc($related_projectmilestones)) {
            ...
            $g->addMilestone(
                $rec_related_projectmilestones['projectmilestoneid'],
                $rec_related_projectmilestones['projectmilestonedate'],
                $rec_related_projectmilestones['projectmilestonename']
            );
        }
