...
class Google_Map_Helper
{
    ...
    static function getLocationFields($module)
    {
        ...
        if ($number >= 1) {
            ...
            switch ($module) {
                case 'Contacts':
                    $retArray = ['street' => 'mailingstreet', 'city' => 'mailingcity', 'state' => 'mailingstate', 'zip' => 'mailingzip', 'country' => 'mailingcountry'];
                    break;
                case 'Leads' :
                    $retArray = ['street' => 'lane', 'city' => 'city', 'state' => 'state', 'zip' => 'code', 'country' => 'country'];
                    break;
                case 'Accounts' :
                    $retArray = ['street' => 'bill_street', 'city' => 'bill_city', 'state' => 'bill_state', 'zip' => 'bill_code', 'country' => 'bill_country'];
                    break;
                default :
                    $retArray = [];
                    break;
