...
class Import_Utils_Helper
{
    ...
    static $supportedFileEncoding = ['UTF-8' => 'UTF-8', 'ISO-8859-1' => 'ISO-8859-1'];
    static $supportedDelimiters = [',' => 'comma', ';' => 'semicolon', '|' => 'Pipe', '^' => 'Caret'];
    static $supportedFileExtensions = ['csv', 'vcf'];
    ...
    public static function validateFileUpload($request)
    {
        ...
        if ($_FILES['import_file']['size'] > $uploadMaxSize) {
            $request->set(
                'error_message',
                vtranslate('LBL_IMPORT_ERROR_LARGE_FILE', 'Import') .
