...
class Settings_Profiles_Record_Model extends Settings_Vtiger_Record_Model
{
    ...
    public $profile_tab_permissions;
    public $profile_tab_field_permissions;
    public $module_permissions;
    public $profile_utility_permissions;
    public $profile_action_permissions;
    ...
    public function saveUserAccessbleFieldsIntoProfile2Field()
    {
        ...
        if (!empty($profileId)) {
            ...
            foreach ($moduleFields as $fieldName => $fieldModel) {
                if (in_array($fieldName, $allowedFields) || $fieldModel->getFieldDataType() == 'string' || $fieldModel->getFieldDataType(
                    ) == 'email' || $fieldModel->getFieldDataType() == 'phone') {
