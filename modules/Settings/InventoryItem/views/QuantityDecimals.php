...
class Settings_InventoryItem_QuantityDecimals_View extends Settings_Vtiger_Index_View
{
    public function process(Vtiger_Request $request)
    {
        ...
        $decimals = InventoryItem_Utils_Helper::fetchQuantityDecimals();
        ...
        $viewer->view('Decimals.tpl', $qualifiedName);
    }
