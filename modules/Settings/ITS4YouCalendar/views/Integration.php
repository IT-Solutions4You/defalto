...
class Settings_ITS4YouCalendar_Integration_View extends Settings_Vtiger_Index_View
{
    public function process(Vtiger_Request $request)
    {
        ...
        $viewer->assign('SUPPORTED_MODULES', Settings_ITS4YouCalendar_Integration_Model::getModules());
