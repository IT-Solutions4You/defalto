...
class Settings_ITS4YouCalendar_Integration_Model extends Vtiger_Base_Model
{
    /**
     * @var array
     */
    ...
    /**
     * @param $module
     * @return false|Settings_ITS4YouCalendar_Integration_Model
     */
    ...
    {
        $this->fieldModule = Vtiger_Module_Model::getInstance('ITS4YouCalendar');
