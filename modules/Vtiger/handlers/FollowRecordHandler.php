                        ...
                        if ($fieldModels) {
                            ...
                            foreach ($userIdsList as $userId) {
                                ...
                                if ($userRecordModel && $userRecordModel->get('status') == 'Active') {
                                    ...
                                    $notificationMessage = ucwords($companyDetails['companyname']) . ' ' . vtranslate(
                                            'LBL_NOTIFICATION',
                                            $moduleName
                                        ) . ' - ' . $currentUserModel->getName();
            ...
            if ($fieldModel->isReferenceField()) {
                ...
                switch ($fieldDataType) {
                    ...
                    case 'time'            :
                        ...
                        break;
                    case 'currency'        :
                        $fieldDisplayValue = CurrencyField::convertToUserFormat($fieldCurrentValue, $userEntity, true);
                        break;
