...
$languageStrings = [
    'ERR_FAILED_TO_LOCK_MODULE' => 'Das Modul konnte nicht für den Import gesperrt werden. Erneuter Versuch zu einem späteren Zeitpunkt',
    'ERR_IMPORT_INTERRUPTED' => 'Der aktuelle Import wurde unterbrochen. Bitte versuchen Sie es später noch einmal	',
    'ERR_LOCAL_INFILE_NOT_ON' => 'local_infile-Variable ist auf dem Datenbankserver deaktiviert.',
    'ERR_UNIMPORTED_RECORDS_EXIST' => 'In diesem Stapel können keine weiteren Daten importiert werden. Bitte starten Sie einen neuen Import.',
    'LBL_AVAILABLE_FIELDS' => 'Verfügbare Felder',
    'LBL_CANCEL_IMPORT' => 'Import abbrechen',
    'LBL_CHARACTER_ENCODING' => 'Format',
    'LBL_CHECK_IMPORT_STATUS' => '<br /><br /> Wir empfehlen Ihnen, sich im CRM anzumelden und einige Datensätze zu überprüfen, um zu bestätigen, dass der Import erfolgreich war.',
    ...
    'LBL_DETAILS' => 'Details',
    'LBL_DONE_BUTTON' => 'erldigt',
    'LBL_DUPLICATE_HANDLING' => 'Doppelte Handhabung',
    'LBL_DUPLICATE_RECORD_HANDLING' => 'Datensatz duplizieren Handhabung',
    'LBL_ENABLE_CRON' => '<b>Bitte aktivieren Sie den Cron-Job \\"Geplanter Import\\" im Einstellungsplaner</b>',
    'LBL_ERROR' => 'Fehler',
    ...
    'LBL_IMPORT_CHANGE_UPLOAD_SIZE' => 'Importieren Ändern Upload-Größe',
    'LBL_IMPORT_COMPLETED' => 'Import Abgeschlossen',
    'LBL_IMPORT_DIRECTORY_NOT_WRITABLE' => 'Import-Verzeichnis ist nicht beschreibbar',
    'LBL_IMPORT_ERROR_LARGE_FILE' => 'Import-Fehler Große Datei',
    'LBL_IMPORT_FILE_COPY_FAILED' => 'Import Dateikopie fehlgeschlagen',
    ...
    'LBL_IMPORT_STEP_3_DESCRIPTION_DETAILED' => 'Wählen Sie diese Option, um doppelte Zusammenführungskriterien zu aktivieren und festzulegen	',
    ...
    'LBL_SCHEDULED_IMPORT_DETAILS' => 'Ihr Import wurde geplant und wird innerhalb von 15 Minuten beginnen. Sie erhalten eine E-Mail, nachdem der Import abgeschlossen ist. Bitte stellen Sie sicher, dass der Postausgangsserver und Ihre E-Mail-Adresse für den Empfang von E-Mail-Benachrichtigungen konfiguriert sind.',
    'LBL_SCHEDULE_IMPORT_SUBJECT' => 'Defalto CRM - Geplanter Importbericht für',
    'LBL_SELECTED_FIELDS' => 'Ausgewählte Felder',
    'LBL_SELECT_ICS_FILE' => 'Wählen Sie die ICS-Datei',
    'LBL_SELECT_IMPORT_FILE_FORMAT' => 'Woraus möchten Sie importieren?',
    'LBL_SELECT_MERGE_FIELDS' => 'Wählen Sie die übereinstimmenden Felder aus, um doppelte Datensätze zu finden',
    ...
    'LBL_SPECIFY_MERGE_TYPE' => 'Wählen Sie, wie doppelte Datensätze behandelt werden sollen',
