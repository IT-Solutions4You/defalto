...
$languageStrings = [
    ...
    'LBL_EMAIL_CODE_SEND_FAILED' => 'The verification code could not be sent. Try again or contact your administrator.',
    ...
    'LBL_TPL_BACKUP_SUBJECT' => 'Your 2FA backup codes',
    'LBL_TPL_BACKUP_BODY' => '<p>Hello $username$,</p><p>Here are your 2FA backup codes. Each code works once:</p><p>$codes$</p><p>Keep them somewhere safe.</p><p>$company$</p>',
    'LBL_DONE' => 'Done',
];
