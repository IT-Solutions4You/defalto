...
$languageStrings = [
    ...
    'LBL_SELECTED_ACTION' => 'Selected action',
    'LBL_INSTALL_ACTIONS' => 'Installation actions',
    'LBL_INSTALL_ACTION' => 'Install',
    'LBL_UPDATE_ACTION' => 'Update',
    'LBL_MIGRATE_ACTION' => 'Migrate',
    'LBL_DELETE_ACTION' => 'Delete',
    'LBL_INSTALL_OUTPUT' => 'Operation output',
    'LBL_SELECT_INSTALL_ACTION' => 'Select an action',
    'LBL_SELECT_INSTALL_ACTION_DESCRIPTION' => 'Choose a module and an action to display its installation output here.',
    'LBL_NO_INSTALL_MODULES' => 'No modules with installation support were found.',
    'LBL_INSTALL_WIZARD' => 'Module installation',
    'LBL_INSTALL_WIZARD_DESCRIPTION' => 'Run the required maintenance action and review its output below.',
    'LBL_BACK_TO_INSTALL_MANAGER' => 'Back to Install Manager',
    ...
    'LBL_COMPOSE_EMAIL_WARNING' => ' Warning : Your email might land in spam. Add Defalto as an authorized sender for your domain. Learn more',
    ...
    'LBL_GLOBAL_SEARCH_MINIMUM_LENGTH' => 'Enter at least 2 characters.',
    'LBL_GLOBAL_SEARCH_FILTER' => 'Filter',
    'LBL_GLOBAL_SEARCH_MODULE_SEARCH' => 'Search modules',
    'LBL_GLOBAL_SEARCH_SETTINGS' => 'Global search',
    'LBL_GLOBAL_SEARCH_SETTINGS_DESCRIPTION' => 'Choose which modules and fields are searched from the top bar.',
    ...
    'LBL_CUSTOM' => 'Custom',
    'LBL_LAST_X_PERIODS' => 'Last X periods',
    'LBL_DATE_UNIT_DAY' => 'day',
    'LBL_DATE_UNIT_WEEK' => 'week',
    'LBL_DATE_UNIT_MONTH' => 'month',
    'LBL_DATE_UNIT_QUARTER' => 'quarter',
    'LBL_DATE_UNIT_YEAR' => 'year',
    'LBL_MONTH_NAME_JANUARY' => 'January',
    'LBL_MONTH_NAME_FEBRUARY' => 'February',
    'LBL_MONTH_NAME_MARCH' => 'March',
    'LBL_MONTH_NAME_APRIL' => 'April',
    'LBL_MONTH_NAME_MAY' => 'May',
    'LBL_MONTH_NAME_JUNE' => 'June',
    'LBL_MONTH_NAME_JULY' => 'July',
    'LBL_MONTH_NAME_AUGUST' => 'August',
    'LBL_MONTH_NAME_SEPTEMBER' => 'September',
    'LBL_MONTH_NAME_OCTOBER' => 'October',
    ...
    'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT' => 'For exporting Currency values in Line items, Defalto will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
    ...
    'LBL_BLANK' => '-Blank-',
    'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'Defalto CRM On Demand',
    ...
    'LBL_SUMMARY_WIDGETS' => 'Summary widgets',
    ...
    'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
									Defalto contacts and Google contacts(in selected group) updated.<br>
    ...
    'LBL_SOCIAL_LINKED' => 'Your Defalto is now linked to',
    'LBL_ENTER_KEYWORDS_HELP' => 'Defalto will scan twitter and find messages with these words',
    ...
    'LBL_SHARED_TAGS_ACCESS' => 'Shared tags are accessible by all users in Defalto',
    ...
    'LBL_TIME' => 'Time',
    'LBL_SKIPPED' => 'Skipped',
    'vt_create' => 'Records Created in Defalto',
    'vt_update' => 'Records Updated in Defalto',
    'vt_delete' => 'Records Deleted in Defalto',
    'vt_skip' => 'Records skipped in Defalto',
    ...
    'LBL_SWITCH_TO_VTIGER7_NOW' => 'Switch to Defalto7 by Feb 15th',
    ...
    'LBL_DUPLICATES_FOUND_MESSAGE' => 'This %s cannot be saved since duplicate %s exists in Defalto with matching values for %s.',
    'LBL_VTIGER_NOTIFICATION' => 'Message from : Defalto System Notifications',
    ...
    'LBL_POSTAL_CODE_DATABASE' => 'Postal code database',
    'LBL_DATASET_VERSION' => 'Version',
    'LBL_RECORDS' => 'records',
    'LBL_NO_DATASET_IMPORTED' => 'No postal code data imported yet',
    'LBL_COUNTRY_CODE_OPTIONAL' => 'Country code (optional)',
    'LBL_UPDATE_NOW' => 'Update now',
    'LBL_POSTAL_UPDATE_HINT' => 'Leave empty to import the whole world, or enter a 2-letter country code (e.g. SK) to import a single country.',
    'LBL_POSTAL_CODES_UPDATED' => 'Postal code database updated',
    'LBL_POSTAL_CODES_AVAILABLE' => 'Postal codes available',
    'LBL_ADDRESS_FIELD_MAPPING' => 'Address field mapping',
    'LBL_ADDRESS_FIELD_MAPPING_DESC' => 'Define which address fields hold the postal code and city (and optionally the state and country) so they can be auto-completed.',
    'LBL_ADD_ADDRESS_GROUP' => 'Add address group',
    'LBL_GROUP_LABEL' => 'Label',
    'LBL_GROUP_LABEL_PLACEHOLDER' => 'e.g. Billing',
    'LBL_ZIP_FIELD' => 'Postal code field',
    'LBL_CITY_FIELD' => 'City field',
    'LBL_STATE_FIELD' => 'State field',
    'LBL_COUNTRY_FIELD' => 'Country field',
    'LBL_NOT_MAPPED' => 'Not mapped',
    'LBL_ADDRESS_ZIP_CITY_REQUIRED' => 'Each address group needs both a postal code field and a city field.',
    'LBL_ADDRESS_MAPPING_SAVED' => 'Address field mapping saved',
    ...
    'LBL_INVENTORY_ITEMS_BLOCK_EDIT' => 'Inventory Items Block Edit',
    'LBL_INVENTORY_BLOCK_AUTOGENERATED' => 'Inventory block automatically generated',
    'LBL_PARENT_OWNER_FIELDS' => 'Parent Owner fields',
    ...
    'User Privileges Directory' => 'User Privileges Directory',
    'User Privileges Default Module View File' => 'User Privileges Default Module View File',
    'User Privileges Enable Backup File' => 'User Privileges Enable Backup File',
    'Modules Directory' => 'Modules Directory',
    'Layouts Directory' => 'Layouts Directory',
    'Language Directory' => 'Language Directory',
    'Cron Modules Directory' => 'Cron Modules Directory',
    ...
    'User Image Directory' => 'User Image Directory',
...
$jsLanguageStrings = [
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, Defalto will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
    ...
    'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable Defalto field not available for mapping',
    ...
    'JS_DASHBOARD_MOVING' => 'Moving widget',
    'JS_DASHBOARD_RESIZING' => 'Resizing widget',
    'JS_DASHBOARD_RELEASE_TO_SAVE' => 'Release to save the layout',
    ...
    'JS_MORE_VTIGER' => 'There are more records to be synchronized in Defalto',
    ...
    'JS_LOADING' => 'Loading...',
    'JS_SUMMARY_WIDGET_LOAD_FAILED' => 'The widget could not be loaded.',
    'JS_RETRY' => 'Try again',
    ...
    'JS_LBL_HELP' => 'Help',
    'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from Defalto support team',
