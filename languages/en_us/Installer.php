...
$languageStrings = [
    ...
    'LBL_MODULE_ACTIVE' => 'Module is active',
    'LBL_MODULE_INACTIVE' => 'Module is deactivated',
    'LBL_MODULE_FILES_MISSING' => 'Module files are not installed',
    ...
    'LBL_CHECK_LICENSE' => 'Check license',
    'LBL_LICENSE_STATUS' => 'License status',
    'LBL_LICENSED_USERS' => 'Licensed users',
    'LBL_LAST_SUCCESSFUL_LICENSE_CHECK' => 'Last successful check',
    'LBL_LICENSE_ERROR' => 'License error',
    'LBL_LICENSE_DETAILS' => 'License details',
    'LBL_ACTIVATED_MODULES' => 'Activated modules',
    'LBL_NO_ACTIVATED_MODULES' => 'No activated modules',
    'LBL_NEVER' => 'Never',
    'LBL_NO_LICENSE_KEY' => 'No license key has been entered.',
    'LBL_LICENSE_DOWNLOAD_UNAVAILABLE' => 'Download is unavailable while the license is inactive.',
    'LBL_LICENSE_ERROR_INVALID_REQUEST' => 'The license server rejected an invalid request.',
    'LBL_LICENSE_ERROR_INVALID_ACTION' => 'The license server rejected an invalid action.',
    'LBL_LICENSE_ERROR_INVALID_USER_COUNT' => 'The active user count is invalid. Check the user configuration.',
    'LBL_LICENSE_ERROR_INVALID_LICENSE' => 'The license key is invalid.',
    'LBL_LICENSE_ERROR_MISSING_EXPIRATION' => 'The license expiration date is missing.',
    'LBL_LICENSE_ERROR_EXPIRED_LICENSE' => 'The license has expired.',
    'LBL_LICENSE_ERROR_USER_LIMIT_MISSING' => 'The license user limit is missing. Contact the license administrator.',
    'LBL_LICENSE_ERROR_USER_LIMIT_EXCEEDED' => 'The license was deactivated because the allowed number of users was exceeded. Reduce the number of active users or upgrade the license, then reactivate it.',
    'LBL_LICENSE_ERROR_CONNECTION_ERROR' => 'The license server is temporarily unavailable or returned an invalid response. Licensed features were set to inactive until a successful check.',
    'LBL_LICENSE_CHECK_LOG' => 'License check log',
    'LBL_LICENSE_CHECK_READY' => 'Review the current status and continue to run a new license check.',
    'LBL_LICENSE_CHECK_CONTINUE' => 'Continue',
    'LBL_LICENSE_CHECK_STARTED' => 'License check started.',
    'LBL_LICENSE_CHECK_FINISHED' => 'License check finished.',
    'LBL_LICENSE_DATA' => 'License data (license key hidden)',
];
$jsLanguageStrings = [
    'JS_INSTALLATION_FAILED' => 'Installation failed. Review the server log and try again.',
