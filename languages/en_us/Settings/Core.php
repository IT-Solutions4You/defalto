...
$languageStrings = [
    ...
    'LBL_SUMMARY_WIDGET_EDITOR' => 'Widget editor',
    'LBL_SUMMARY_WIDGET_EDITOR_DESCRIPTION' => 'Configure the widgets displayed in each module Summary View',
    'LBL_AVAILABLE_SUMMARY_WIDGETS' => 'Available widgets',
    'LBL_NO_AVAILABLE_SUMMARY_WIDGETS' => 'All defined widgets have already been added',
    'LBL_ADD_SUMMARY_WIDGET' => 'Add widget',
    'LBL_SUMMARY_WIDGETS_DESCRIPTION' => 'Drag widgets to change their order or move them between the two Summary View columns.',
    'LBL_LEFT_COLUMN' => 'Left column',
    'LBL_RIGHT_COLUMN' => 'Right column',
    'LBL_DROP_SUMMARY_WIDGET_HERE' => 'Drop a widget here',
    'LBL_MOVE_SUMMARY_WIDGET' => 'Move widget',
    'LBL_SUMMARY_WIDGET_REMOVE_CONFIRMATION' => 'Do you want to remove this widget from the Summary View?',
    'LBL_SUMMARY_WIDGET_ADDED' => 'The widget was added',
    'LBL_SUMMARY_WIDGET_REMOVED' => 'The widget was removed',
    'LBL_SUMMARY_WIDGET_ORDER_SAVED' => 'The widget layout was saved',
    'LBL_CREATE_SUMMARY_LIST_WIDGET' => 'Create list widget',
    'LBL_EDIT_SUMMARY_LIST_WIDGET' => 'Edit list widget',
    'LBL_WIDGET_TITLE' => 'Widget title',
    'LBL_TARGET_MODULE' => 'Displayed module',
    'LBL_LIST_FILTER' => 'List filter',
    'LBL_DISPLAY_FIELDS' => 'Displayed fields',
    'LBL_SELECT_UP_TO_THREE_FIELDS' => 'Select one to three fields.',
    'LBL_SORT_SELECTED_FIELDS' => 'Drag the selected fields to set the column order.',
    'LBL_RELATION_TYPE' => 'Relation type',
    'LBL_REFERENCE_FIELD_RELATION' => 'Reference field',
    'LBL_RELATED_LIST_RELATION' => 'Related list',
    'LBL_REFERENCE_FIELD' => 'Reference field',
    'LBL_RELATED_LIST' => 'Related list',
    'LBL_NO_AVAILABLE_RELATION' => 'No usable relation is available for these modules.',
    'LBL_SUMMARY_LIST_WIDGET_SAVED' => 'The list widget was created',
    'LBL_SUMMARY_LIST_WIDGET_UPDATED' => 'The list widget was updated',
    'LBL_SUMMARY_WIDGET_NAME_EXISTS' => 'A widget with this title already exists for the module.',
    'LBL_INVALID_SUMMARY_LIST_WIDGET' => 'Enter a valid title and select one to three fields.',
    'LBL_SUMMARY_WIDGET_URL_TOO_LONG' => 'The selected module and fields produce a widget URL longer than the supported limit.',
    ...
    'LBL_SERVER_UPLOAD_LIMIT' => 'Server (PHP) limit: %s MB',
