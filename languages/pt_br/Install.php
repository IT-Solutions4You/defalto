...
$languageStrings = [
    ...
    'LBL_VTIGER7_SETUP_WIZARD_DESCRIPTION' => 'Este assistente irá guiá-lo através da instalação do Vtiger CRM',
    'LBL_WELCOME_TO_VTIGER7_SETUP_WIZARD'  => 'Bem Vindo(a) ao Assistente de Configuração do Vtiger CRM',
