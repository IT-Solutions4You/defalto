...
$languageStrings = [
    ...
    'LBL_MAX_UPLOAD_SIZE'                    => 'Максимальный размер вложений',
    ...
    'LBL_SERVER_UPLOAD_LIMIT'                => 'Ограничение сервера (PHP): %s МБ',
    ...
    'LBL_LOGO_RECOMMENDED_MESSAGE'           => '(формат .jpeg, .jpg, .png, .gif, .pjpeg, .x-PNG)',
