...
$languageStrings = [
    ...
    'LBL_UPLOAD_SIZE_EXCEEDS_LIMIT'          => 'Maksimum yükleme boyutu yapılandırılan sınırı aşıyor',
    ...
    'LBL_LOGO_RECOMMENDED_MESSAGE'           => '(.jpeg, .jpg, .png, .gif, .pjpeg, .x-png formatında)',
