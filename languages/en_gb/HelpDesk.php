...
$languageStrings = [
    ...
    'customer_portal'                  => 'in the "Customer Portal" at Defalto.',
    'link'                             => 'You can use the following link to view the replies made:',
    'Thanks'                           => 'Thanks',
    'Support_team'                     => 'Defalto Support Team',
    ...
    //Do not convert this label. This is used to check the status. If the status 'Closed' is changed in Defalto server side then you have to change in customerportal language file also.
