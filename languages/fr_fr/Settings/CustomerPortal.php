...
$languageStrings = [
    ...
    'LBL_DEFAULT_ASSIGNEE_MESSAGE' => 'Cas / billets seront cédés au cessionnaire choisi par le Groupe par défaut / utilisateur dans le portail client.',
...
$jsLanguageStrings = [
    'JS_PORTAL_INFO_SAVED'        => 'Paramètres de portail client sauvegardés',
    "LBL_ADD_DOCUMENT"            => "Ajouter un document",
    "LBL_OPEN_TICKETS"            => "Billets ouverts",
    "LBL_CREATE_TICKET"           => "Créer un Ticket",
