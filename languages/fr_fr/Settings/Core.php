...
$languageStrings = [
    ...
    'LBL_MAX_UPLOAD_SIZE'                    => 'Taille maximale de téléchargement',
    ...
    'LBL_SERVER_UPLOAD_LIMIT'                => 'Limite serveur (PHP) : %s Mo',
    ...
    'LBL_LOGO_RECOMMENDED_MESSAGE'     => '(format .jpeg, .jpg, .png, .gif, .pjpeg, .x-png)',
    ...
    'company_reg_no' => 'N° d\'immatriculation',
    ...
    'country_id' => 'Pays',
    'LBL_BANK_INFORMATION' => 'Informations bancaires',
];
$jsLanguageStrings = [
