<?php
/**
 * This file originates from the vtiger CRM Open Source project.
 * It is subject to the vtiger CRM Public License Version 1.0.
 * See the LICENSE.txt file distributed with the original source code.
 * /
 /**
    ...
    function yylex1()
    {
        ...
        do {
            if (preg_match($yy_global_pattern, substr($this->data, $this->index), $yymatches)) {
                ...
                throw new Exception(
                    'Unexpected input at line' . $this->linenum .
